 ...
 */
class CRM_Postcodenl_Upgrader_Base {

  /**
   * @var CRM_Postcodenl_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Postcodenl_Upgrader(
   ...
   *
   * ```
   * CRM_Postcodenl_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Postcodenl_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
